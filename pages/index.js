...
<h2 className="text-3xl lg:text-5xl text-center mb-12">1. Storytelling on Social Platforms</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">2. Influencer Partnerships</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">3. Buying YouTube Views</h2> 
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">4. Interactive Content</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">5. Video Marketing</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">6. Personalization</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">7. Social Listening</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">8. Chatbots</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">9. User-Generated Content</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">10. Ephemeral Content</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">11. Augmented Reality (AR)</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">Why These Ways Work</h2>
...
<h2 className="text-3xl lg:text-5xl text-center mb-12">Conclusion</h2>
